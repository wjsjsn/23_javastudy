...
public class Ex06_Cafe extends JFrame {
	public Ex06_Cafe() {
		super("카페 주문");
		...
		JRadioButton jrb4 = new JRadioButton("과일주스(3000)");
		...
		JButton jbu1 = new JButton("계  산");
		JButton jbu2 = new JButton("종  료");
		JButton jbu3 = new JButton("취  소");

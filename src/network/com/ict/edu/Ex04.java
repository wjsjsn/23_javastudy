...
// 피싱 : 구분 분석, 문장을 이루고 있는 구성 성분을 분해하고 분해된 성분의 관계를 분석하여 구조를 결정하는 것
//          즉, 데이터를 분해 분석하여 원하는 형태로 조립하고, 다시 빼는 과정
...
public class Ex04 {
	public static void main(String[] args) {
		...
		// 파일 쓰기
		String pathname = "D:" + File.separator + "pcl" + File.separator + "오늘날씨.txt";
